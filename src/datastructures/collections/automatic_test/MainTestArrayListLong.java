...
import datastructures.collections.list.ArrayListLong;
import datastructures.collections.list.ListLong;
...
public class MainTestArrayListLong {
	...
	private static void runExperiment(int initialSize) {
		...
		//-------------------------- Iterator
		datastructures.collections.list.ListLong.IteratorList iterator = list.iterator();
