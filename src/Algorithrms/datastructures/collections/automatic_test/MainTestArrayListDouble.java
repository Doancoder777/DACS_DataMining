...
import datastructures.collections.list.ArrayListDouble;
import datastructures.collections.list.ListDouble;
import datastructures.collections.list.ListInt.IteratorList;
...
public class MainTestArrayListDouble {
	...
	private static void runExperiment(int initialSize) {
		...
		//-------------------------- Iterator
		datastructures.collections.list.ListDouble.IteratorList iterator = list.iterator();
