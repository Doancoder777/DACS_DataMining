...
import datastructures.collections.map.AMapIntToDouble;
import datastructures.collections.map.AMapIntToInt;
import datastructures.collections.map.LMapIntToFloat;
import datastructures.collections.map.LMapIntToInt;
import datastructures.collections.map.LMapIntToLong;
import datastructures.collections.map.MapIntToDouble;
import datastructures.collections.map.MapIntToLong;
import datastructures.collections.map.MapIntToDouble.MapEntryIntToDouble;
import datastructures.collections.map.MapIntToDouble.EntryIterator;
import datastructures.collections.map.MapIntToInt;
...
public class MainTestAMapIntToDouble {
	...
	private static void runExperiment(int bucketCount, int collisionArraySize) {
		...
		datastructures.collections.map.MapIntToDouble.ValueIterator iterVal = hashMap2.iteratorForValues();
		...
		//===== KEY ITERATOR
		datastructures.collections.map.MapIntToDouble.KeyIterator iterKey = hashMap2.iteratorForKeys();
