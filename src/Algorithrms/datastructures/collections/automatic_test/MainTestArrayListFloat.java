...
import datastructures.collections.list.ArrayListFloat;
import datastructures.collections.list.ListFloat;
...
public class MainTestArrayListFloat {
	...
	private static void runExperiment(int initialSize) {
		...
		//-------------------------- Iterator
		datastructures.collections.list.ListFloat.IteratorList iterator = list.iterator();
