...
import datastructures.collections.map.AMapIntToFloat;
import datastructures.collections.map.MapIntToDouble;
import datastructures.collections.map.MapIntToFloat;
import datastructures.collections.map.LMapIntToFloat.LValueIterator;
import datastructures.collections.map.MapIntToFloat.MapEntryIntToFloat;
import datastructures.collections.map.MapIntToFloat.ValueIterator;
import datastructures.collections.map.MapIntToFloat.EntryIterator;
...
public class MainTestAMapIntToFloat {
	...
	private static void runExperiment(int bucketCount, int collisionArraySize) {
		...
		//===== KEY ITERATOR
		datastructures.collections.map.MapIntToFloat.KeyIterator iterKey = hashMap2.iteratorForKeys();
