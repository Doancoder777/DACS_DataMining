...
import datastructures.collections.list.ArrayListShort;
import datastructures.collections.list.ListShort;
...
public class MainTestArrayListShort {
	...
	private static void runExperiment(int initialSize) {		
		...
		//-------------------------- Iterator
		datastructures.collections.list.ListShort.IteratorList iterator = list.iterator();
